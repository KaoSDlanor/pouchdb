...
function createAbstractMapReduce(localDocName, mapper, reducer, ddocValidator) {
  ...
  async function getDocsToPersist(docId, view, docIdsToChangesAndEmits) {
    ...
    function processKeyValueDocs(metaDoc, kvDocsRes) {
      const kvDocs = [];
      const oldKeys = new pouchdbCollections.Set();
  ...
  async function updateViewInQueue(view, opts) {
    ...
    function createDocIdsToChangesAndEmits(results) {
      const docIdsToChangesAndEmits = new pouchdbCollections.Map();
    ...
    function createIndexableKeysToKeyValues(mapResults) {
      const indexableKeysToKeyValues = new pouchdbCollections.Map();
      let lastKey;
  ...
  function queryView(view, opts) {
    ...
    pouchdbMapreduceUtils.sequentialize(queue, function () {
  ...
  async function queryViewInQueue(view, opts) {
    ...
    if (typeof opts.keys !== 'undefined') {
      ...
      const flattenedResult = pouchdbUtils.flatten(result);
  ...
  async function localViewCleanup(db) {
    try {
      ...
      const docsToViews = new pouchdbCollections.Map();
